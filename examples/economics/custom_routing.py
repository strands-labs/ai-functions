...
SKILL_MIDPOINT = {economics.haiku.label: 3.2, economics.sonnet.label: 4.2}
...
@routed(models=[economics.haiku, economics.sonnet], value=VALUE, beliefs=RatioBeliefs(), policy=Greedy())
