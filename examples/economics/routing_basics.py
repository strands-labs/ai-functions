...
A batch of 3-SAT instances — mostly easy, one hard (see ``example_helpers/economics.py``
...
from example_helpers import economics
from example_helpers.economics import check_sat, format_instance, make_instance
from example_helpers.utils import console, display, rule
...
@routed(models=[economics.haiku, economics.sonnet], value=0.50)
