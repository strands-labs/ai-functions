...
df = import_invoice.run_sync(path="examples/data/invoice.json")
...
df = import_invoice.run_sync(path="examples/data/invoice.sqlite3")

# Merge revisions of the same product
df = fuzzy_merge_products.run_sync(invoice=df)
