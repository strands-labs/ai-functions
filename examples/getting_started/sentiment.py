...
@ai_function(model=models.small, post_conditions=[check_uppercase], max_attempts=3)
...
def analyze_review(review: str) -> dict:
    sentiment = classify_sentiment.run_sync(review=review)
    summary = summarize_review.run_sync(review=review)
