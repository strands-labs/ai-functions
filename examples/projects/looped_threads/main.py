...
from plotting import plot_learning_curve, read_experiments
...
@ai_function[Literal["done"]](model=models.medium, tools=[read_file, write_file, run_python], max_attempts=MAX_ATTEMPTS)
